...
/*@
 ...
 context _next_sol__buffer->dim[2].min == 0 && _next_sol__buffer->dim[2].extent == 8 && _next_sol__buffer->dim[2].stride == 4;
 context _next_sol__buffer->dim[3].min == 0 && _next_sol__buffer->dim[3].extent == 50 && _next_sol__buffer->dim[3].stride == 32;
 ...
 context _next_solutions__1_buffer->dim[2].min == 0 && _next_solutions__1_buffer->dim[2].extent == 8 && _next_solutions__1_buffer->dim[2].stride == 4;
 context _next_solutions__1_buffer->dim[3].min == 0 && _next_solutions__1_buffer->dim[3].extent == 50 && _next_solutions__1_buffer->dim[3].stride == 32;
 context (\forall* int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < 8 && 0 <= _3 && _3 < 50; {:next_solutions__1_pred(_next_solutions__1_buffer->host, _0, 0, 2, _1, 0, 2, _2, 0, 8, _3, 0, 50):});
 context true;
@*/
int StepHalide(bool _phase_only, double _step_size, struct halide_buffer_double *_sol__buffer, struct halide_buffer_double *_next_sol__buffer, struct halide_buffer_double *_next_solutions__1_buffer) {
 ...
 halide_unused((_next_sol__extent_2 == 8));
 halide_unused((_next_sol__stride_3 == 32));
 halide_unused((_next_sol__min_3 == 0));
 halide_unused((_next_sol__extent_3 == 50));
 ...
 halide_unused((_next_solutions__1_extent_2 == 8));
 halide_unused((_next_solutions__1_stride_3 == 32));
 ...
 /*@
  ...
  loop_invariant (\forall* int _next_solutions__1_s0_a_forall, int _next_solutions__1_s0_si_forall, int _next_solutions__1_s0_i_forall, int _next_solutions__1_s0_c_forall; 0 <= _next_solutions__1_s0_a_forall && _next_solutions__1_s0_a_forall < 50 && 0 <= _next_solutions__1_s0_si_forall && _next_solutions__1_s0_si_forall < 8 && 0 <= _next_solutions__1_s0_i_forall && _next_solutions__1_s0_i_forall < 2 && 0 <= _next_solutions__1_s0_c_forall && _next_solutions__1_s0_c_forall < 2; {:next_solutions__1_pred(_next_solutions__1, _next_solutions__1_s0_c_forall, 0, 2, _next_solutions__1_s0_i_forall, 0, 2, _next_solutions__1_s0_si_forall, 0, 8, _next_solutions__1_s0_a_forall, 0, 50):});
 @*/
 for (int _next_solutions__1_s0_a = 0; _next_solutions__1_s0_a < 0 + 50; _next_solutions__1_s0_a++)
 {
  int32_t _t7997 = (_next_solutions__1_s0_a * 16);
  /*@
   loop_invariant 0 <= _next_solutions__1_s0_si && _next_solutions__1_s0_si <= 0 + 8;
   loop_invariant [1\2]_float64_pred(_next_sol_);
   loop_invariant [1\2]_float64_pred(_sol_);
   loop_invariant (\forall* int _next_solutions__1_s0_si_forall, int _next_solutions__1_s0_i_forall, int _next_solutions__1_s0_c_forall; 0 <= _next_solutions__1_s0_si_forall && _next_solutions__1_s0_si_forall < 8 && 0 <= _next_solutions__1_s0_i_forall && _next_solutions__1_s0_i_forall < 2 && 0 <= _next_solutions__1_s0_c_forall && _next_solutions__1_s0_c_forall < 2; {:next_solutions__1_pred(_next_solutions__1, _next_solutions__1_s0_c_forall, 0, 2, _next_solutions__1_s0_i_forall, 0, 2, _next_solutions__1_s0_si_forall, 0, 8, _next_solutions__1_s0_a, 0, 50):});
  @*/
  for (int _next_solutions__1_s0_si = 0; _next_solutions__1_s0_si < 0 + 8; _next_solutions__1_s0_si++)
  {
   int32_t _t7999 = ((_next_solutions__1_s0_si * 2) + _t7997);
   /*@
    loop_invariant 0 <= _next_solutions__1_s0_i && _next_solutions__1_s0_i <= 0 + 2;
    loop_invariant [1\2]_float64_pred(_next_sol_);
    loop_invariant [1\2]_float64_pred(_sol_);
    loop_invariant (\forall* int _next_solutions__1_s0_i_forall, int _next_solutions__1_s0_c_forall; 0 <= _next_solutions__1_s0_i_forall && _next_solutions__1_s0_i_forall < 2 && 0 <= _next_solutions__1_s0_c_forall && _next_solutions__1_s0_c_forall < 2; {:next_solutions__1_pred(_next_solutions__1, _next_solutions__1_s0_c_forall, 0, 2, _next_solutions__1_s0_i_forall, 0, 2, _next_solutions__1_s0_si, 0, 8, _next_solutions__1_s0_a, 0, 50):});
   @*/
   ...
   {
    {
     ...
     /*@ ghost to_pred_distance(_distance, _next_solutions__1_s0_i, 1, _next_solutions__1_s0_si, 1, _next_solutions__1_s0_a, 1);
      @*/
     // produce distance
     int32_t _t7988 = (_next_solutions__1_s0_i + _t7999);
     double _647 = 
     /*@ with
     ...
     _distance[0]= (atan2_f64(_647, _648) - atan2_f64(_649, _650));
     ...
     /*@
      unfold distance_pred(_distance, _next_solutions__1_s0_i, _next_solutions__1_s0_i, 1, _next_solutions__1_s0_si, _next_solutions__1_s0_si, 1, _next_solutions__1_s0_a, _next_solutions__1_s0_a, 1); @*/
     _distance[0]= (((3.141593 < _t7989) ? -6.283185 : 6.283185) + _t7989);
     /*@ fold distance_pred(_distance, _next_solutions__1_s0_i, _next_solutions__1_s0_i, 1, _next_solutions__1_s0_si, _next_solutions__1_s0_si, 1, _next_solutions__1_s0_a, _next_solutions__1_s0_a, 1); @*/
     // consume distance
     int32_t _t7990 = (_next_solutions__1_s0_i + _t7999);
     double _652 = 
     /*@ with
      unfold [1\2]_float64_pred(_sol_); @*/
      _sol_[(_t7990 * 2)]
     ...
     ;
     /*@
      unfold next_solutions__1_pred(_next_solutions__1, 0, 0, 2, _next_solutions__1_s0_i, 0, 2, _next_solutions__1_s0_si, 0, 8, _next_solutions__1_s0_a, 0, 50); @*/
     _next_solutions__1[(_t7990 * 2)]= (_phase_only ? cos_f64((atan2_f64(_653, _t7991) + (_654 * _step_size))) : (((1.000000 - _step_size) * _t7991) + (_655 * _step_size)));
     /*@ fold next_solutions__1_pred(_next_solutions__1, 0, 0, 2, _next_solutions__1_s0_i, 0, 2, _next_solutions__1_s0_si, 0, 8, _next_solutions__1_s0_a, 0, 50); @*/
    ...
    } // alloc _distance
    {
     ...
     /*@ ghost to_pred_distance(_distance, _next_solutions__1_s0_i, 1, _next_solutions__1_s0_si, 1, _next_solutions__1_s0_a, 1);
      @*/
     // produce distance
     int32_t _t7992 = (_next_solutions__1_s0_i + _t7999);
     double _656 = 
     /*@ with
      unfold [1\2]_float64_pred(_sol_); @*/
      _sol_[((_t7992 * 2) + 1)]
     ...
     /*@
      unfold distance_pred(_distance, _next_solutions__1_s0_i, _next_solutions__1_s0_i, 1, _next_solutions__1_s0_si, _next_solutions__1_s0_si, 1, _next_solutions__1_s0_a, _next_solutions__1_s0_a, 1); @*/
     _distance[0]= (atan2_f64(_656, _657) - atan2_f64(_658, _659));
     /*@ fold distance_pred(_distance, _next_solutions__1_s0_i, _next_solutions__1_s0_i, 1, _next_solutions__1_s0_si, _next_solutions__1_s0_si, 1, _next_solutions__1_s0_a, _next_solutions__1_s0_a, 1); @*/
     double _660 = 
     /*@ with
      unfold [1\2]distance_pred(_distance, _next_solutions__1_s0_i, _next_solutions__1_s0_i, 1, _next_solutions__1_s0_si, _next_solutions__1_s0_si, 1, _next_solutions__1_s0_a, _next_solutions__1_s0_a, 1); @*/
     ...
     /*@
      unfold distance_pred(_distance, _next_solutions__1_s0_i, _next_solutions__1_s0_i, 1, _next_solutions__1_s0_si, _next_solutions__1_s0_si, 1, _next_solutions__1_s0_a, _next_solutions__1_s0_a, 1); @*/
     _distance[0]= (((3.141593 < _t7993) ? -6.283185 : 6.283185) + _t7993);
     /*@ fold distance_pred(_distance, _next_solutions__1_s0_i, _next_solutions__1_s0_i, 1, _next_solutions__1_s0_si, _next_solutions__1_s0_si, 1, _next_solutions__1_s0_a, _next_solutions__1_s0_a, 1); @*/
     // consume distance
     int32_t _t7994 = (_next_solutions__1_s0_i + _t7999);
     double _661 = 
     /*@ with
      unfold [1\2]_float64_pred(_sol_); @*/
      _sol_[((_t7994 * 2) + 1)]
     ...
     /*@ with
      unfold [1\2]_float64_pred(_next_sol_); @*/
      _next_sol_[((_t7994 * 2) + 1)]
     /*@ then
      fold [1\2]_float64_pred(_next_sol_); @*/
     ;
     /*@
      unfold next_solutions__1_pred(_next_solutions__1, 1, 0, 2, _next_solutions__1_s0_i, 0, 2, _next_solutions__1_s0_si, 0, 8, _next_solutions__1_s0_a, 0, 50); @*/
     _next_solutions__1[((_t7994 * 2) + 1)]= (_phase_only ? sin_f64((atan2_f64(_t7995, _662) + (_663 * _step_size))) : (((1.000000 - _step_size) * _t7995) + (_664 * _step_size)));
     /*@ fold next_solutions__1_pred(_next_solutions__1, 1, 0, 2, _next_solutions__1_s0_i, 0, 2, _next_solutions__1_s0_si, 0, 8, _next_solutions__1_s0_a, 0, 50); @*/
     /*@ ghost from_pred_distance(_distance, _next_solutions__1_s0_i, 1, _next_solutions__1_s0_si, 1, _next_solutions__1_s0_a, 1);
      @*/
    } // alloc _distance
