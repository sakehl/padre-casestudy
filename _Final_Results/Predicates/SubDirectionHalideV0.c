...
/*@
 ...
 context \pointer_length(_v_res_out_buffer->host) == _v_res_out_buffer->dim[3].extent * _v_res_out_buffer->dim[3].stride;
...
int SubDirection(struct halide_buffer_double *_sol__buffer, struct halide_buffer_int32_t *_solution_map_buffer, struct halide_buffer_int32_t *_ant1_buffer, struct halide_buffer_int32_t *_ant2_buffer, struct halide_buffer_float *_model__buffer, struct halide_buffer_float *_v_res_in_buffer, int32_t _solution_index0, struct halide_buffer_float *_v_res_out_buffer) {
 ...
 {
  int64_t _212 = 230930;
  float *_v_res0_0 = (float  *)malloc(sizeof(float )*_212);
  /*@ ghost to_pred_v_res0_0(_v_res0_0, 0, 230930);
   @*/
  {
   int64_t _213 = 230930;
   float *_v_res0_1 = (float  *)malloc(sizeof(float )*_213);
   /*@ ghost to_pred_v_res0_1(_v_res0_1, 0, 230930);
    @*/
   {
    int64_t _214 = 230930;
    float *_v_res0_2 = (float  *)malloc(sizeof(float )*_214);
    /*@ ghost to_pred_v_res0_2(_v_res0_2, 0, 230930);
     @*/
    {
     int64_t _215 = 230930;
     float *_v_res0_3 = (float  *)malloc(sizeof(float )*_215);
     /*@ ghost to_pred_v_res0_3(_v_res0_3, 0, 230930);
      @*/
     {
      int64_t _216 = 230930;
      float *_v_res0_4 = (float  *)malloc(sizeof(float )*_216);
      /*@ ghost to_pred_v_res0_4(_v_res0_4, 0, 230930);
       @*/
      {
       int64_t _217 = 230930;
       float *_v_res0_5 = (float  *)malloc(sizeof(float )*_217);
       /*@ ghost to_pred_v_res0_5(_v_res0_5, 0, 230930);
        @*/
       {
        int64_t _218 = 230930;
        float *_v_res0_6 = (float  *)malloc(sizeof(float )*_218);
        /*@ ghost to_pred_v_res0_6(_v_res0_6, 0, 230930);
         @*/
        {
         int64_t _219 = 230930;
         float *_v_res0_7 = (float  *)malloc(sizeof(float )*_219);
         ...
         for (int _v_res_out_s0_v = 0; _v_res_out_s0_v < 0 + 230930; _v_res_out_s0_v++)
         {
          /*@
           ...
           loop_invariant (\forall* int _v; 0 <= _v && _v < 230930; {:[1\2]v_res0_6_pred(_v_res0_6, _v, 0, 230930):});
           loop_invariant (\forall* int _v; 0 <= _v && _v < 230930; {:[1\2]v_res0_7_pred(_v_res0_7, _v, 0, 230930):});
           loop_invariant (\forall* int _v_res_out_s0_j_forall, int _v_res_out_s0_i_forall, int _v_res_out_s0_c_forall; 0 <= _v_res_out_s0_j_forall && _v_res_out_s0_j_forall < 2 && 0 <= _v_res_out_s0_i_forall && _v_res_out_s0_i_forall < 2 && 0 <= _v_res_out_s0_c_forall && _v_res_out_s0_c_forall < 2; {:v_res_out_pred(_v_res_out, _v_res_out_s0_c_forall, 0, 2, _v_res_out_s0_i_forall, 0, 2, _v_res_out_s0_j_forall, 0, 2, _v_res_out_s0_v, 0, 230930):});
          @*/
          for (int _v_res_out_s0_j = 0; _v_res_out_s0_j < 0 + 2; _v_res_out_s0_j++)
          {
           bool _t3679 = (_v_res_out_s0_j == 1);
           bool _t3677 = (_v_res_out_s0_j == 0);
           int32_t _t3680 = (((_v_res_out_s0_v * 2) + _v_res_out_s0_j) * 4);
           /*@
            ...
            loop_invariant (\forall* int _v; 0 <= _v && _v < 230930; {:[1\2]v_res0_6_pred(_v_res0_6, _v, 0, 230930):});
            loop_invariant (\forall* int _v; 0 <= _v && _v < 230930; {:[1\2]v_res0_7_pred(_v_res0_7, _v, 0, 230930):});
            loop_invariant (\forall* int _v_res_out_s0_i_forall, int _v_res_out_s0_c_forall; 0 <= _v_res_out_s0_i_forall && _v_res_out_s0_i_forall < 2 && 0 <= _v_res_out_s0_c_forall && _v_res_out_s0_c_forall < 2; {:v_res_out_pred(_v_res_out, _v_res_out_s0_c_forall, 0, 2, _v_res_out_s0_i_forall, 0, 2, _v_res_out_s0_j, 0, 2, _v_res_out_s0_v, 0, 230930):});
           @*/
           for (int _v_res_out_s0_i = 0; _v_res_out_s0_i < 0 + 2; _v_res_out_s0_i++)
           {
            bool _t3683 = (_v_res_out_s0_i == 1);
            bool _t3681 = (_v_res_out_s0_i == 0);
            int32_t _t3684 = ((_v_res_out_s0_i * 2) + _t3680);
            /*@
             ...
             loop_invariant (\forall* int _v; 0 <= _v && _v < 230930; {:[1\2]v_res0_6_pred(_v_res0_6, _v, 0, 230930):});
             loop_invariant (\forall* int _v; 0 <= _v && _v < 230930; {:[1\2]v_res0_7_pred(_v_res0_7, _v, 0, 230930):});
             loop_invariant (\forall* int _v_res_out_s0_c_forall; 0 <= _v_res_out_s0_c_forall && _v_res_out_s0_c_forall < 2; {:v_res_out_pred(_v_res_out, _v_res_out_s0_c_forall, 0, 2, _v_res_out_s0_i, 0, 2, _v_res_out_s0_j, 0, 2, _v_res_out_s0_v, 0, 230930):});
            @*/
            for (int _v_res_out_s0_c = 0; _v_res_out_s0_c < 0 + 2; _v_res_out_s0_c++)
            {
             bool _t3640 = (_v_res_out_s0_c == 0);
             bool _t3642 = (_t3640 && _t3681);
             int32_t _228 = 
             /*@ with
             ...
             ;
             int32_t _t3645_s = _229;
             double _230 = 
             /*@ with
              unfold [1\2]_float64_pred(_sol_); @*/
              _sol_[((((_t3645_s * 8) + _t3644) * 4) + 1)]
             /*@ then
             ...
             ;
             int32_t _t3647_s = _232;
             double _233 = 
             /*@ with
              unfold [1\2]_float64_pred(_sol_); @*/
              _sol_[(((_t3647_s * 8) + _t3644) * 4)]
             /*@ then
              fold [1\2]_float64_pred(_sol_); @*/
             ;
             ...
             /*@ with
              unfold [1\2]_float64_pred(_sol_); @*/
              _sol_[((((_t3647_s * 8) + _t3644) * 4) + 1)]
             /*@ then
              fold [1\2]_float64_pred(_sol_); @*/
             ;
             float _238 = (float)(_237);
             float _t3651 = _238;
             float _t3652 = ((_t3648 * _t3649) + (_t3650 * _t3651));
             float _t3653 = ((_t3648 * _t3650) - (_t3649 * _t3651));
             double _239 = 
             /*@ with
              unfold [1\2]_float64_pred(_sol_); @*/
              _sol_[(((_t3645_s * 8) + _t3644) * 4)]
             /*@ then
              fold [1\2]_float64_pred(_sol_); @*/
             ;
             float _240 = (float)(_239);
             float _t3654 = _240;
             bool _t3655 = (_v_res_out_s0_c == 1);
             bool _t3656 = (_t3655 && _t3681);
             bool _t3658 = (_t3640 && _t3683);
             double _241 = 
             /*@ with
              unfold [1\2]_float64_pred(_sol_); @*/
              _sol_[((((_t3645_s * 8) + _t3644) * 4) + 3)]
             /*@ then
              fold [1\2]_float64_pred(_sol_); @*/
             ;
             ...
             ;
             float _t3661 = _244;
             float _t3662 = ((_t3648 * _t3660) + (_t3651 * _t3661));
             float _t3663 = ((_t3648 * _t3661) - (_t3651 * _t3660));
             double _245 = 
             /*@ with
              unfold [1\2]_float64_pred(_sol_); @*/
              _sol_[((((_t3645_s * 8) + _t3644) * 4) + 2)]
             /*@ then
              fold [1\2]_float64_pred(_sol_); @*/
             ;
             ...
             /*@ with
              unfold [1\2]_float64_pred(_sol_); @*/
              _sol_[((((_t3647_s * 8) + _t3644) * 4) + 3)]
             /*@ then
              fold [1\2]_float64_pred(_sol_); @*/
             ;
             float _252 = (float)(_251);
             float _t3669 = _252;
             float _t3670 = ((_t3666 * _t3667) + (_t3668 * _t3669));
             float _t3671 = ((_t3666 * _t3668) - (_t3667 * _t3669));
             float _253 = 
             /*@ with
              unfold [1\2]_float32_pred(_model_); @*/
             ...
             ;
             float _t3673 = _254;
             float _t3674 = ((_t3666 * _t3672) + (_t3669 * _t3673));
             float _t3675 = ((_t3666 * _t3673) - (_t3669 * _t3672));
             float _255 = 
             /*@ with
              unfold [1\2]v_res0_0_pred(_v_res0_0, _v_res_out_s0_v, 0, 230930); @*/
              _v_res0_0[_v_res_out_s0_v]
             /*@ then
              fold [1\2]v_res0_0_pred(_v_res0_0, _v_res_out_s0_v, 0, 230930); @*/
             ;
             float _256 = 
             /*@ with
              unfold [1\2]v_res0_1_pred(_v_res0_1, _v_res_out_s0_v, 0, 230930); @*/
              _v_res0_1[_v_res_out_s0_v]
             /*@ then
              fold [1\2]v_res0_1_pred(_v_res0_1, _v_res_out_s0_v, 0, 230930); @*/
             ;
             float _257 = 
             /*@ with
              unfold [1\2]v_res0_2_pred(_v_res0_2, _v_res_out_s0_v, 0, 230930); @*/
              _v_res0_2[_v_res_out_s0_v]
             /*@ then
              fold [1\2]v_res0_2_pred(_v_res0_2, _v_res_out_s0_v, 0, 230930); @*/
             ;
             float _258 = 
             /*@ with
              unfold [1\2]v_res0_3_pred(_v_res0_3, _v_res_out_s0_v, 0, 230930); @*/
              _v_res0_3[_v_res_out_s0_v]
             /*@ then
              fold [1\2]v_res0_3_pred(_v_res0_3, _v_res_out_s0_v, 0, 230930); @*/
             ;
             float _259 = 
             /*@ with
              unfold [1\2]v_res0_4_pred(_v_res0_4, _v_res_out_s0_v, 0, 230930); @*/
              _v_res0_4[_v_res_out_s0_v]
             /*@ then
              fold [1\2]v_res0_4_pred(_v_res0_4, _v_res_out_s0_v, 0, 230930); @*/
             ;
             float _260 = 
             /*@ with
              unfold [1\2]v_res0_5_pred(_v_res0_5, _v_res_out_s0_v, 0, 230930); @*/
              _v_res0_5[_v_res_out_s0_v]
             /*@ then
              fold [1\2]v_res0_5_pred(_v_res0_5, _v_res_out_s0_v, 0, 230930); @*/
             ;
             float _261 = 
             /*@ with
              unfold [1\2]v_res0_6_pred(_v_res0_6, _v_res_out_s0_v, 0, 230930); @*/
              _v_res0_6[_v_res_out_s0_v]
             /*@ then
              fold [1\2]v_res0_6_pred(_v_res0_6, _v_res_out_s0_v, 0, 230930); @*/
             ;
             float _262 = 
             /*@ with
              unfold [1\2]v_res0_7_pred(_v_res0_7, _v_res_out_s0_v, 0, 230930); @*/
              _v_res0_7[_v_res_out_s0_v]
             /*@ then
              fold [1\2]v_res0_7_pred(_v_res0_7, _v_res_out_s0_v, 0, 230930); @*/
             ;
             /*@
              unfold v_res_out_pred(_v_res_out, _v_res_out_s0_c, 0, 2, _v_res_out_s0_i, 0, 2, _v_res_out_s0_j, 0, 2, _v_res_out_s0_v, 0, 230930); @*/
             _v_res_out[(_t3684 + _v_res_out_s0_c)]= ((_t3642 && _t3677) ? (_255 + (((0.000000 - _t3646) * _t3652) - (_t3653 * _t3654))) : ((_t3656 && _t3677) ? (_256 - (((0.000000 - _t3646) * _t3653) + (_t3652 * _t3654))) : ((_t3658 && _t3677) ? (_257 + (((0.000000 - _t3659) * _t3662) - (_t3663 * _t3664))) : (((_t3655 && _t3683) && _t3677) ? (_258 - (((0.000000 - _t3659) * _t3663) + (_t3662 * _t3664))) : ((_t3642 && _t3679) ? (_259 + (((0.000000 - _t3646) * _t3670) - (_t3654 * _t3671))) : ((_t3656 && _t3679) ? (_260 - (((0.000000 - _t3646) * _t3671) + (_t3654 * _t3670))) : ((_t3658 && _t3679) ? (_261 + (((0.000000 - _t3659) * _t3674) - (_t3664 * _t3675))) : (_262 - (((0.000000 - _t3659) * _t3675) + (_t3664 * _t3674))))))))));
             /*@ fold v_res_out_pred(_v_res_out, _v_res_out_s0_c, 0, 2, _v_res_out_s0_i, 0, 2, _v_res_out_s0_j, 0, 2, _v_res_out_s0_v, 0, 230930); @*/
            } // for _v_res_out_s0_c
           } // for _v_res_out_s0_i
          } // for _v_res_out_s0_j
         } // for _v_res_out_s0_v
