  ...
  for (int _v_res_out_s0_j = 0; _v_res_out_s0_j < 0 + 2; _v_res_out_s0_j++)
  {
   ...
   for (int _v_res_out_s0_i = 0; _v_res_out_s0_i < 0 + 2; _v_res_out_s0_i++)
   {
    ...
    for (int _v_res_out_s0_c = 0; _v_res_out_s0_c < 0 + 2; _v_res_out_s0_c++)
    {
     ...
     /*@
     ghost lemma_nonlinear(_104, _sol__stride_3, _n_antennas);
     @*/
     ...
     /*@
     ghost lemma_nonlinear(_101, _sol__stride_3, _n_antennas); // Not needed
     assert ((_t5719 * 4) + _t5718)>=0;
     assert ((_t5719 * 4) + _t5718)<_n_solutions*_n_antennas*4;
     @*/
