...
void lemma_nonlinear(int a, int b, int max_a){
  ...
  ghost
  requires a >= 0 && a<extent_a;
  requires b >= 0 && b<extent_b;
  requires c >= 0 && c<extent_c;
  requires d >= 0 && d<extent_d;
  requires stride_a > 0;
  requires stride_b >= extent_a*stride_a;
  requires stride_c >= extent_b*stride_b;
  requires stride_d >= extent_c*stride_c;

  ensures a*stride_a + b*stride_b < stride_b*extent_b;
  ensures a*stride_a + b*stride_b + c*stride_c < stride_c*extent_c;
  ensures a*stride_a + b*stride_b + c*stride_c +d*stride_d < stride_d*extent_d;
void lemma_4d_access(int a, int b, int c, int d,
  int stride_a, int stride_b, int stride_c, int stride_d,
  int extent_a, int extent_b, int extent_c, int extent_d){
    lemma_nonlinear(a, stride_a, extent_a);
    lemma_nonlinear(b, stride_b, extent_b);
    lemma_nonlinear(c, stride_c, extent_c);
    lemma_nonlinear(d, stride_d, extent_d);
}
@*/
  ...
  for (int _v_res_out_s0_j = 0; _v_res_out_s0_j < 0 + 2; _v_res_out_s0_j++)
  {
   ...
   for (int _v_res_out_s0_i = 0; _v_res_out_s0_i < 0 + 2; _v_res_out_s0_i++)
   {
    ...
    for (int _v_res_out_s0_c = 0; _v_res_out_s0_c < 0 + 2; _v_res_out_s0_c++)
    {
     ...
     int32_t _t5719 = _102;
     /*@
     ghost lemma_4d_access(1, 0, _102, _101, 
                           1, 2, 4, 4*_n_solutions,
                           2, 2, _n_solutions, _n_antennas);
     assert (((_t5719 * 4) + _t5718) + 1) < 4*_n_solutions*_n_antennas;
     @*/
     ...
     /*@
     ghost lemma_4d_access(0, 0, _102, _104, 
                           1, 2, 4, 4*_n_solutions,
                           2, 2, _n_solutions, _n_antennas);
    assert ((_t5719 * 4) + _t5722) < 4*_n_solutions*_n_antennas;
     @*/
     ...
     /*@
     ghost lemma_4d_access(1, 0, _102, _104, 
                           1, 2, 4, 4*_n_solutions,
                           2, 2, _n_solutions, _n_antennas);
    assert (((_t5719 * 4) + _t5722) + 1) < 4*_n_solutions*_n_antennas;
     @*/
     ...
     /*@
     ghost lemma_4d_access(0, 0, _102, _101, 
                           1, 2, 4, 4*_n_solutions,
                           2, 2, _n_solutions, _n_antennas);
     assert ((_t5719 * 4) + _t5718) < 4*_n_solutions*_n_antennas;
     @*/
     ...
     /*@
     ghost lemma_4d_access(1, 1, _102, _101, 
                           1, 2, 4, 4*_n_solutions,
                           2, 2, _n_solutions, _n_antennas);
     assert (((_t5719 * 4) + _t5718) + 3) < 4*_n_solutions*_n_antennas;
     @*/
    ...
    /*@
     ghost lemma_4d_access(0, 1, _102, _101, 
                           1, 2, 4, 4*_n_solutions,
                           2, 2, _n_solutions, _n_antennas);
     assert (((_t5719 * 4) + _t5718) + 2) < 4*_n_solutions*_n_antennas;
     @*/
     float _109 = (float)(_sol_[(((_t5719 * 4) + _t5718) + 2)]);
     float _t5740 = _109;
    /*@
     ghost lemma_4d_access(0, 1, _102, _104, 
                           1, 2, 4, 4*_n_solutions,
                           2, 2, _n_solutions, _n_antennas);
     assert (((_t5719 * 4) + _t5722) + 2) < 4*_n_solutions*_n_antennas;
     @*/
     ...
     /*@
     ghost lemma_4d_access(1, 1, _102, _104, 
                           1, 2, 4, 4*_n_solutions,
                           2, 2, _n_solutions, _n_antennas);
     assert (((_t5719 * 4) + _t5722) + 3) < 4*_n_solutions*_n_antennas;
     @*/
