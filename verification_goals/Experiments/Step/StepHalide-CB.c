...
/*@
 ...
 context (\forall* int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < _n_solutions && 0 <= _3 && _3 < _n_antennas; Perm(&_next_sol__buffer->host[_3*_n_solutions*4 + _2*4 + _1*2 + _0], 1\2));
 context (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < _n_solutions && 0 <= _3 && _3 < _n_antennas; _next_sol__buffer->host[_3*_n_solutions*4 + _2*4 + _1*2 + _0] == pure_next_sol_(_3*_n_solutions*4 + _2*4 + _1*2 + _0));
 ...
 context (\forall* int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < _n_solutions && 0 <= _3 && _3 < _n_antennas; Perm(&_next_solutions__1_buffer->host[_3*_n_solutions*4 + _2*4 + _1*2 + _0], 1\1));
...
int StepHalide(int32_t _n_vis, int32_t _n_solutions, int32_t _n_antennas, bool _phase_only, double _step_size, struct halide_buffer_double *_sol__buffer, struct halide_buffer_double *_next_sol__buffer, struct halide_buffer_double *_next_solutions__1_buffer) {
 ...
 /*@
  ...
  loop_invariant (\forall* int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < _n_solutions && 0 <= _3 && _3 < _n_antennas; Perm(&_next_sol_[((_3*_n_solutions + _2)*2 + _1)*2 + _0], 1\2));
  ...
  loop_invariant (\forall* int _next_solutions__1_s0_c_forall, int _next_solutions__1_s0_i_forall, int _next_solutions__1_s0_si_forall, int _next_solutions__1_s0_a_forall; 0 <= _next_solutions__1_s0_a_forall && _next_solutions__1_s0_a_forall < _n_antennas && 0 <= _next_solutions__1_s0_si_forall && _next_solutions__1_s0_si_forall < _n_solutions && 0 <= _next_solutions__1_s0_i_forall && _next_solutions__1_s0_i_forall < 2 && 0 <= _next_solutions__1_s0_c_forall && _next_solutions__1_s0_c_forall < 2; Perm(&_next_solutions__1[_next_solutions__1_s0_i_forall*2 + _next_solutions__1_s0_a_forall*_n_solutions * 4 + _next_solutions__1_s0_si_forall*4 + _next_solutions__1_s0_c_forall], 1\1));
 @*/
 for (int _next_solutions__1_s0_a = 0; _next_solutions__1_s0_a < 0 + _n_antennas; _next_solutions__1_s0_a++)
 {
  int32_t _t389 = (_next_solutions__1_s0_a * _sol__stride_3);
  int32_t _t392 = (_next_solutions__1_s0_a * _next_solutions__1_stride_3);
  int32_t _t390 = (_next_sol__stride_3 * _next_solutions__1_s0_a);
  /*@
   ...
   loop_invariant (\forall* int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < _n_solutions && 0 <= _3 && _3 < _n_antennas; Perm(&_sol_[((_3*_n_solutions + _2)*2 + _1)*2 + _0], 1\2));
   loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < _n_solutions && 0 <= _3 && _3 < _n_antennas; _sol_[((_3*_n_solutions + _2)*2 + _1)*2 + _0] == pure_sol_(((_3*_n_solutions + _2)*2 + _1)*2 + _0));
   loop_invariant (\forall* int _next_solutions__1_s0_c_forall, int _next_solutions__1_s0_i_forall, int _next_solutions__1_s0_si_forall; 0 <= _next_solutions__1_s0_si_forall && _next_solutions__1_s0_si_forall < _n_solutions && 0 <= _next_solutions__1_s0_i_forall && _next_solutions__1_s0_i_forall < 2 && 0 <= _next_solutions__1_s0_c_forall && _next_solutions__1_s0_c_forall < 2; Perm(&_next_solutions__1[_next_solutions__1_s0_a*_next_solutions__1_stride_3 + (_next_solutions__1_s0_si_forall*2 + _next_solutions__1_s0_i_forall)*2 + _next_solutions__1_s0_c_forall], 1\1));
  @*/
  for (int _next_solutions__1_s0_si = 0; _next_solutions__1_s0_si < 0 + _n_solutions; _next_solutions__1_s0_si++)
  {
   int32_t _t393 = (_next_solutions__1_s0_si * 2);
   /*@
    ...
    loop_invariant (\forall* int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < _n_solutions && 0 <= _3 && _3 < _n_antennas; Perm(&_sol_[((_3*_n_solutions + _2)*2 + _1)*2 + _0], 1\2));
    loop_invariant (\forall int _0, int _1, int _2, int _3; 0 <= _0 && _0 < 2 && 0 <= _1 && _1 < 2 && 0 <= _2 && _2 < _n_solutions && 0 <= _3 && _3 < _n_antennas; _sol_[((_3*_n_solutions + _2)*2 + _1)*2 + _0] == pure_sol_(((_3*_n_solutions + _2)*2 + _1)*2 + _0));
    loop_invariant (\forall* int _next_solutions__1_s0_c_forall, int _next_solutions__1_s0_i_forall; 0 <= _next_solutions__1_s0_i_forall && _next_solutions__1_s0_i_forall < 2 && 0 <= _next_solutions__1_s0_c_forall && _next_solutions__1_s0_c_forall < 2; Perm(&_next_solutions__1[_next_solutions__1_s0_si*4 + _next_solutions__1_s0_a*_next_solutions__1_stride_3 + _next_solutions__1_s0_i_forall*2 + _next_solutions__1_s0_c_forall], 1\1));
   @*/
   ...
   {
    {
     double _distance[1];
     // produce distance
     int32_t _t380 = (_next_solutions__1_s0_i + _t393);
     int32_t _t381 = ((_t380 * 2) + _t389);
     int32_t _t382 = ((_t380 * 2) + _t390);
     double _3 = _sol_[(_t381 + 1)];
     double _4 = _sol_[_t381];
     double _5 = _next_sol_[(_t382 + 1)];
     double _6 = _next_sol_[_t382];
     _distance[0] = (atan2_f64(_3, _4) - atan2_f64(_5, _6));
     double _7 = _distance[0];
     double _t369 = _7;
     _distance[0] = (((3.141593 < _t369) ? -6.283185 : 6.283185) + _t369);
     // consume distance
     double _8 = _sol_[(((_next_solutions__1_s0_i + _t393) * 2) + _t389)];
     double _t372 = _8;
     int32_t _t383 = (_next_solutions__1_s0_i + _t393);
     double _9 = _sol_[(((_t383 * 2) + _t389) + 1)];
     double _10 = _distance[0];
     double _11 = _next_sol_[((_t383 * 2) + _t390)];
     _next_solutions__1[((_t383 * 2) + _t392)] = (_phase_only ? cos_f64((atan2_f64(_9, _t372) + (_10 * _step_size))) : (((1.000000 - _step_size) * _t372) + (_11 * _step_size)));
    } // alloc _distance
    {
     double _distance[1];
     // produce distance
     int32_t _t384 = (_next_solutions__1_s0_i + _t393);
     int32_t _t385 = ((_t384 * 2) + _t389);
     int32_t _t386 = ((_t384 * 2) + _t390);
     double _12 = _sol_[(_t385 + 1)];
     double _13 = _sol_[_t385];
     double _14 = _next_sol_[(_t386 + 1)];
     double _15 = _next_sol_[_t386];
     _distance[0] = (atan2_f64(_12, _13) - atan2_f64(_14, _15));
     double _16 = _distance[0];
     double _t376 = _16;
     _distance[0] = (((3.141593 < _t376) ? -6.283185 : 6.283185) + _t376);
     // consume distance
     double _17 = _sol_[((((_next_solutions__1_s0_i + _t393) * 2) + _t389) + 1)];
     double _t379 = _17;
     int32_t _t387 = (_next_solutions__1_s0_i + _t393);
     double _18 = _sol_[((_t387 * 2) + _t389)];
     double _19 = _distance[0];
     double _20 = _next_sol_[(((_t387 * 2) + _t390) + 1)];
     _next_solutions__1[(((_t387 * 2) + _t392) + 1)] = (_phase_only ? sin_f64((atan2_f64(_t379, _18) + (_19 * _step_size))) : (((1.000000 - _step_size) * _t379) + (_20 * _step_size)));
    } // alloc _distance
